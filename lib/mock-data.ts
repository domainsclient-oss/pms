...
const service = (url: string, username: string, password: string, notes = "") => ({ url, username, password, notes });
...
export const projects: Project[] = [
  {
    ...
    description: "A high-volume commerce experience for a multi-brand retail group.",
    owner: "Maya Chen",
  ...
  },
  {
    ...
    description: "Secure patient engagement and care coordination portal.",
    owner: "Jordan Smith",
  ...
  },
  {
    ...
    client: "Shoreline Architecture",
    type: "Website",
    status: "Testing",
    startDate: "2025-02-20",
    launchDate: "2025-06-09",
    description: "An editorial portfolio site for a coastal architecture practice.",
    owner: "Maya Chen",
  ...
  },
  {
    ...
    client: "Forge Industrial Group",
    type: "WordPress",
    status: "Maintenance",
    startDate: "2024-09-04",
    launchDate: "2024-11-22",
    description: "A product catalogue and lead generation site for industrial manufacturing.",
    owner: "Alex Rivera",
  ...
  },
  {
    id: "kindred",
    name: "Kindred Goods",
    client: "Kindred Goods Ltd.",
    type: "Shopify",
    status: "Completed",
    startDate: "2024-04-12",
    launchDate: "2024-07-01",
    description: "A refined Shopify storefront for a sustainable home goods label.",
    owner: "Alex Rivera",
